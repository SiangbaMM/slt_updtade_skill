...
st.title(":cup_with_straw: Customize tour Smoothie :cup_with_straw:")
st.write(
...
# Convert snowpark dataframe into pandas dataframe so that we can use the loc function
...
if ingredients_list :
    ...
    for fruits in ingredients_list :
        ...
        #fruityvice_response = requests.get("https://fruityvice.com/api/fruit/" + fruits)
